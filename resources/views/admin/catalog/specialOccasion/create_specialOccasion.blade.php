...
<section class="content">
  ...
  <div id="full-body">
    <div class="card shadow mb-4">
      <div class="card-body">
        <form method="POST" action="{{ route('admin.storeSepcialOccasion') }}" enctype="multipart/form-data">
          @csrf
        ...
        <div class="row">
            <div class="col-6">
                <div class="mb-4">
                    ...
                    <input class="dropify" id="formFile" name="image" type="file" data-min-height="900" data-min-width="1750" accept="image/png, image/jpeg, image/jpg"/>
                </div>
                <div class="mb-2">
            ...
            <div class="col-6">
                <div class="mt-4 mb-4">
                    <input class="form-check-input m-1" type="radio" name="product_type" id="sp-product" value="1">
                    <label class="form-check-label m-1" for="formradioRight5">{{__('main.product')}}</label>
                    <input class="form-check-input m-1" type="radio" name="product_type" id="sp-package" value="2">
                ...
                <div class="mb-2">
                    <x-create_lang_input>
                        ...
                        <x-slot name="field_placeholder">{{__('main.Enter Special Occasion Name')}}</x-slot>
                    </x-create_lang_input>
                    {{-- <label class="form-label" for="name">{{__('main.name')}}</label>
                    <input class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" type="text" placeholder="{{__('main.Enter Special Occasion Name')}}" required autofocus> --}}
                </div>
                <div class="mb-2">
                    <label class="form-label">{{__('main.date_range')}}</label>
                    <input type="text" class="form-control" name="dateRange" data-provider="flatpickr" data-minDate="yesterday" data-date-format="Y-m-d" data-range-date="true" data-altFormat="F j, Y">
                </div>
            </div>
        </div>
...
<script>
  ...
  $(document).ready(function () {
    ...
    $('body').on('click','.add_new_product_button',function(e){
        ...
        console.log(selectedProduct,itemId,"selected Product");
        $('#add_more').html();
    ...
    $('body').on('click','.add_new_package_button',function(e){
        ...
        console.log(selectedPackage,itemId,"selected Product");
        $('#add_more').html();
        $('#add_more').append(`<tr id="packageTr${itemId}">
                            <td>
                                <div class="text-center">
                                    ${selectedPackage.id}
                                </div>
