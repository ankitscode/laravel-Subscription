      ...
      <div class="card-body">
            ...
            <div class="col-md-6">
                ...
                <select name="parent_package[]" class="form-control" id="choices-multiple-default" data-choices data-choices-removeItem multiple required>
                    @foreach ($parentPackages as $parentPackage)
                        <option value="{{$parentPackage['id']}}" data-name="{{$parentPackage['parent_package_name']}}" data-tokens="{{$parentPackage['parent_package_name']}}">{{$parentPackage['parent_package_name']}}</option>
                    @endforeach
                </select>
            </div>
        </div>
        <div class="row gx-3 mb-3">
            <div class="col-md-6">
                ...
                <textarea class="form-control" name="package_description[en]" id="package_description" placeholder="{{__('main.english_field')}}" rows='2' cols='50' style="@if(app()->getLocale() == 'en') display: block; @else display: none; @endif" required autofocus ></textarea>
                <textarea class="form-control" name="package_description[ar]" id="package_description" placeholder="{{__('main.arabic_field')}}" rows='2' cols='50' style="@if(app()->getLocale() == 'ar') display: block; @else display: none; @endif" required autofocus ></textarea>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3">
                            <label class="form-label" for="product-price-input">{{__('main.original_price')}} <code>({{__('main.required')}})</code></label>
                            <div class="input-group has-validation mb-3">
                                <span class="input-group-text" id="product-price-addon">$</span>
                                <input type="number" name="original_price" class="form-control" id="originalprice" placeholder="{{__('main.Enter Original Price')}}" aria-label="Price" aria-describedby="product-price-addon" required>
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            <label class="form-label" for="product-price-input">{{__('main.profit_percentage')}} <code>({{__('main.required')}})</code></label>
                            <div class="input-group has-validation mb-3">
                                <span class="input-group-text" id="product-price-addon">%</span>
                                <input type="number" name="profit_percentage" class="form-control" id="profitpercentage" placeholder="{{__('main.Enter Profit Percentage')}}" aria-label="Price" aria-describedby="product-price-addon" required>
                                <div class="invalid-feedback">{{__('main.Please Enter a Package price')}}</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group has-validation mb-3">
                                <span class="input-group-text" id="product-price-addon">$</span>
                                <input type="price" name="price" class="form-control" id="sellingprice" placeholder="{{__('main.Enter Selling Price')}}" aria-label="Price" aria-describedby="product-price-addon" required>
                                <div class="invalid-feedback">{{__('main.Please Enter a Package price')}}</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group has-validation mb-3">
                                <span class="input-group-text" id="product-price-addon">$</span>
                                <input type="number" name="profit" class="form-control" id="profit" aria-label="Price" aria-describedby="product-price-addon" required>
                                <div class="invalid-feedback">{{__('main.Please Enter a Package price')}}</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group has-validation mb-3">
                                <span class="input-group-text" id="product-price-addon">$</span>
                                <input type="number" name="discount" class="form-control" id="discount" placeholder="{{__('main.Enter Discount value')}}" aria-label="Price" aria-describedby="product-price-addon" required>
        ...
        <div class="row gx-3 mb-3 dropdownattribute" id="dropdownOption">
            <fieldset class="box-body" id="attributeField">
                ...
                <tfoot>
                    <tr>
                      <th colspan="5" class="">
                        <a href="javascript:void(0)" class="btn btn-soft-primary" data-bs-toggle="modal" data-bs-target="#productModal">{{__('main.add_product')}}</a>
                        </button>
                      </th>
                    </tr>
                  </tfoot>
                    ...
                    <div class="swiper product-thumbnail-slider p-2 rounded bg-light">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide    ">
                                ...
                                <img src="{{ isset($product['productimage']) ? $product['productimage'] : asset("assets/images/No_Image_Available.jpg")}}" alt="{{$product['producttitle'][app()->getLocale()]}}"
...
<script>
    ...
    $(document).ready(function(){
        $('.dropify').dropify();
        var rowIdx = 1;
        $('body').on('click', '#add_new_option_button', function (e) {
            e.preventDefault();
        ...
        $('#add_more').append(`<tr id="R${++rowIdx}"><td><div class="row d-flex flex-row">
                        ...
                        <div class="col-lg-2 col-md-6 col-md-2 col-12 product-data">
                            ...
                            <input type="hidden" id="single-price-original${rowIdx}" name="">
    ...
    function productDropdown(value){
        ...
        const singleFieldOriginal       = "#single-price-original"+value+"";
        ...
        if (output !== "") {
            ...
            doProductPriceAjax(output,variantvalue).then( (response) => {
                if (response.status === 1){
                    ...
                    $(singleFieldOriginal).prop('name','field_data['+output+']['+variantvalue+'][orignial_price]');
                    $(singleFieldOriginal).val(response.productDetatis['originalprice']);
