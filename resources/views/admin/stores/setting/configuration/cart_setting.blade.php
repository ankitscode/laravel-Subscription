  ...
  <div class="row">
    <div class="col-12">
      <ul class="nav nav-tabs customtab2" role="tablist">
        ...
        <li class="nav-item"> <a class="nav-link active" href="{{route('admin.cartCleanIndexConfiguration')}}" role="tab"><span class="hidden-sm-up"><i class="fa fa-shopping-cart" aria-hidden="true"></i></span> <span class="hidden-xs-down">{{__('main.cart_setting')}}</span> </a> </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{route('admin.paymentMethodIndexConfiguration')}}" role="tab">
            <span class="hidden-sm-up"><i class="fa fa-fw fa-credit-card" aria-hidden="true"></i></span>
            ...
            <div class="col-xl-12">
              <div class="box box-bordered border-primary m-10">
                <div class="box-header with-border">
                  <h4 class="box-title text-primary"><strong>{{ __('main.cart_setting') }}</strong></h4>
                </div>
                <div class="box-body">
                  <form class="form" method="POST" action="{{ route('admin.cartCleanByDayStoreConfiguration') }}"
                    enctype="multipart/form-data">
                    @csrf
                      <div class="form-group row">
                        <label for="days" class="col-sm-2 col-form-label">{{__('main.clean_cart_by_days')}}</label>
                        <div class="col-sm-10">
                        <input class="form-control" name="days" type="number" @if (isset($cartSetting)) value="{{$cartSetting->data}}" @else value="{{ old('days') }}" @endif>
                        </div>
                      </div>
