  ...
  <div class="row">
    <div class="col-12">
      <ul class="nav nav-tabs customtab2" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{{route('admin.currencyIndexConfiguration')}}" role="tab"> <span class="hidden-sm-up"><i class="fa fa-fw fa-credit-card"></i></span> <span class="hidden-xs-down">{{__('main.payment_method_setting')}}</span> </a>
        </li>
        <li class="nav-item">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                          <select name="data[]" class="js-example-basic-multiple" multiple="multiple" style="width: 50%" required>
