    ...
    $(document).ready(function () {
        $('#adminTable').DataTable({
            ...
            "columns"       : [
                                ...
                                {   "data": "uuid",
                                    "render": function ( data, type, row ) {
                                        return '<li class="list-inline-item edit"><a href="{{route("admin.viewAdmin","")}}/'+row.uuid+'" data-id="'+row.uuid+'" class="text-primary d-inline-block edit-btn"><i class="ri-eye-fill fs-16"></i></a></li><li class="list-inline-item edit"><a href="{{route("admin.editAdmin","")}}/'+row.uuid+'" data-id="'+row.uuid+'" class="text-primary d-inline-block edit-btn"><i class="ri-pencil-fill fs-16"></i></a></li><li class="list-inline-item"><a class="text-danger d-inline-block remove-item-btn"  data-id="'+row.uuid+'" href="javascript:void(0)"><i class="ri-delete-bin-5-fill fs-16"></i></a></li>';
                                    },
                                },
                            ],
            'columnDefs': [
